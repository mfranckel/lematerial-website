...
description: "Solutions to the most common installation, API key, extraction quality, and configuration problems in LeMat-Synth."
summary: ""
...
- Check the [CLI Reference]({{< ref "/lemat-synth/user-guide/cli" >}}) and the
  [Configuration guide]({{< ref "/lemat-synth/developer-guide/configuration" >}}#which-script-uses-which-system)
