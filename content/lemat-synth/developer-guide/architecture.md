---
title: "Architecture"
description: "How LeMat-Synth's pipeline stages, repository layout, and cross-cutting utilities fit together, and where to start when contributing a feature."
summary: ""
...
[`SynthesisPerformancePipeline`]({{< ref "/lemat-synth/api/pipeline" >}}).
...
it reads. See the [Configuration & Models]({{< ref "/lemat-synth/developer-guide/configuration" >}}) page
for details.
